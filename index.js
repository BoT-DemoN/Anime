...
conn.sendMessage(id, 'Owner VIN05 wa.me/+6289527818905' ,MessageType.text);
}
else if (text == 'VIN'){
conn.sendMessage(id, 'aku pembuat vin' ,MessageType.text);
}
else if (text == 'JOMBLO'){
conn.sendMessage(id, 'KEREN' ,MessageType.text);
}
